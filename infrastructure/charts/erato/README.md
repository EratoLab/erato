...
| oauth2Proxy.redis.persistence.accessModes[0] | string | `"ReadWriteOnce"` |  |
...
| postgresql.external.connectionString.value | string | `"postgresql://postgres:postgres@localhost:5432/postgres"` | PostgreSQL connection string (plain value) |
