...
const len0 = data6.length;
for(let i0=0; i0<len0; i0++){
if(!(validate46(data6[i0], {instancePath:instancePath+"/hits/" + i0,parentData:data6,parentDataProperty:i0,rootData}))){
