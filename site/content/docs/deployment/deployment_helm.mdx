...
It is currently published to the repository `oci://registry.eratolabs.com/erato-helm-dev`, and tagged with a fixed `0.1.0` version number followed by the Git commit hash.
...
dependencies:
  - name: erato
    ...
    repository: "oci://registry.eratolabs.com/erato-helm-dev"
```
  ...
  extraConfigFiles:
    ...
    - name: "secrets"
      inlineContent: |
        ...
        [mcp_servers.private_api.authentication]
        mode = "fixed"

        [mcp_servers.private_api.authentication.fixed]
...
[mcp_servers.database_tools.authentication]
mode = "fixed"

[mcp_servers.database_tools.authentication.fixed]
api_key = "database-access-key"
header_name = "Authorization"
prefix = "Bearer "
```
