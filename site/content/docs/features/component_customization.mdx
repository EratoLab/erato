...
flowchart TB
  subgraph MainRepo[Main Repository]
    MainRegistry[componentRegistry.ts<br/>AssistantFileSourceSelector: null<br/>ChatFileSourceSelector: null]
  end

  subgraph CustomerFork[Customer Fork]
    ForkRegistry[componentRegistry.ts<br/>AssistantFileSourceSelector: FileSourceSelectorGrid<br/>ChatFileSourceSelector: null]
    CustomComponent["src/customer/components/FileSourceSelectorGrid.tsx<br/>Custom implementation"]
  end

  ForkRegistry --> CustomComponent
```
...
> **Quick Start:** Copy the example from `frontend/src/customer/examples/FileSourceSelectorGrid.tsx.example`
> to `frontend/src/customer/components/FileSourceSelectorGrid.tsx` and modify as needed.
