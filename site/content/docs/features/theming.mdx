...
| Attachment chip, file chip inside a thread card                                               | `attachment-tile`                                                                        | `--attachment-tile-radius`, derived from the card but never below `0.25rem`; its icon tile follows, never below `0.125rem` | declare `--attachment-tile-radius` on `thread-message-card`                                                             |
