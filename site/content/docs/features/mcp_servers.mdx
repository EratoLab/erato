...
> [!WARNING]
>
> **Not yet supported:** Streamable HTTP is not currently supported in Erato, but support is planned for a future release. You can follow [the MCP specification](https://modelcontextprotocol.io/specification/2025-03-26/basic/transports#streamable-http) for details on the protocol and keep an eye on the Erato changelog for updates.
