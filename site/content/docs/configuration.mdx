...
Browser origins that are embedded as immutable policy in Windows desktop-sidecar
downloads. Entries must be normalized, non-loopback origins in lowercase
