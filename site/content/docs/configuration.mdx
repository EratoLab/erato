...
**Default behavior:** If not configured, Erato uses the `parser-core` processor by default.
...
- `"parser-core"` - The original file processor (default). Provides reliable text extraction for common document formats.
...
| Feature           | parser-core                              | kreuzberg                |
| ----------------- | ---------------------------------------- | ------------------------ |
| Text extraction   | ✅                                       | ✅                       |
| Page awareness    | ❌                                       | ✅                       |
| Page markers      | ❌                                       | ✅ (`<page number="N">`) |
| Output format     | Plain text                               | Markdown                 |
| Supported formats | Word, PDF, Excel, PowerPoint, text files | Same as parser-core      |
