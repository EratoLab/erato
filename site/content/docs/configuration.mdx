...
Facets composed into every task child. Each entry must name a facet configured under `experimental_facets.facets`; an unknown id is rejected at startup. Use this to give task children a capability the origin turn does not need to carry itself, such as web search.
...
{/* erato_toml_config_key: experimental_facets.facets.<facet-id>.hidden */}
{/* erato_toml_config_key: experimental_facets.facets.<facet-id>.hidden_always_active_for_platform */}
...
```toml
[experimental_facets.facets.outlook_baseline]
...
{/* erato_toml_config_key: experimental_facets.facets.<facet-id>.delegation.max_tasks_per_turn */}
{/* erato_toml_config_key: experimental_facets.facets.<facet-id>.delegation.max_server_tool_calls_per_task */}
{/* erato_toml_config_key: experimental_facets.facets.<facet-id>.delegation.max_client_tool_calls_per_task */}
{/* erato_toml_config_key: experimental_facets.facets.<facet-id>.delegation.persona */}
{/* erato_toml_config_key: experimental_facets.facets.<facet-id>.delegation.child_facet_ids.[] */}
