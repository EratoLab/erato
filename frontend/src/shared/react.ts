// @ts-nocheck -- react ships CJS; `export *` cannot be statically enumerated
// by the bundler, so the public API is re-exported explicitly from the
// interop namespace. Runtime identity is the app-bundle React instance.
