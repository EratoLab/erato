...
describe("FeatureConfigProvider", () => {
  ...
  describe("useErrorReportFeature", () => {
    it("should expose verbose assistant errors as disabled by default", () => {
      const { result } = renderHook(() => useErrorReportFeature(), {
        wrapper: createWrapper(),
      });

      expect(result.current.showVerboseAssistantErrors).toBe(false);
    });

    it("should expose verbose assistant errors when enabled by environment", () => {
      mockEnv.mockReturnValue({
        apiRootUrl: "/api/",
        frontendPlatform: "common",
        frontendPublicBasePath: "/public/common",
  ...
  describe("useAssistantsFeature", () => {
    ...
    it("should return configured assistants thresholds", () => {
      mockEnv.mockReturnValue({
        ...
        assistantsShowRecentItemsCollapsible: true,
  ...
  describe("useCloudProvidersFeature", () => {
    it("should include sharepoint and disclaimer config when enabled", () => {
      mockEnv.mockReturnValue({
        apiRootUrl: "/api/",
        frontendPlatform: "common",
        frontendPublicBasePath: "/public/common",
      ...
      const { result } = renderHook(() => useCloudProvidersFeature(), {
        wrapper: createWrapper(),
      });
