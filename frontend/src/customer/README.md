...
| `StarterPrompts`              | Chat           | Prompt suggestions beneath the composer in the chat welcome |
...
only applies to the built-in welcome, where it renders beneath the composer.
