...
import { MessagingProvider } from "../containers/MessagingProvider";
...
const ChatBridge: React.FC<PropsWithChildren> = ({ children }) => {
  return (
    <MessagingProvider
      chatId="global" // We'll use a placeholder ID that will be overridden
      _onChatCreated={(_tempId, _permanentId) => {
        // No-op in the global provider
      }}
    >
