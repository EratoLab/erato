...
const getThemeVariableEntries = (theme: Theme): Array<[string, string]> => {
  ...
  return [
    ...
    ["--theme-border-field", theme.colors.border.field],
    ["--theme-border-field-focus", theme.colors.border.fieldFocus],
    ["--theme-border-chat-input", theme.colors.border.chatInput],
    ["--theme-border-chat-input-focus", theme.colors.border.chatInputFocus],
    ["--theme-border-dropdown", theme.colors.border.dropdown],
    ["--theme-border-media", theme.colors.border.media],
    ["--theme-border-attachment", theme.colors.border.attachment],
    ...
    ["--theme-diff-added-fg", theme.colors.diff.added.foreground],
    ["--theme-diff-added-bg", theme.colors.diff.added.background],
    ["--theme-diff-removed-fg", theme.colors.diff.removed.foreground],
    ["--theme-diff-removed-bg", theme.colors.diff.removed.background],
